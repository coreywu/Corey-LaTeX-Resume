...
\begin{itemize}
\vspace{-6.5pt}
\resskillsitem{Languages}{Java, Python, C\#, C++, Assembly, PHP, MySQL, HTML, CSS, MATLAB}
...
\begin{ressection}{Education}
  \begin{resentry}{Candidate for Bachelor of Applied Science}{University of Waterloo}{Waterloo, ON}{Sept. 2012 -- Present}
	...
	\textbf{\hspace{5pt} Android Map Navigation App}   
    \begin{itemize}
	...
	\begin{itemize}
	\resawardentry{\hspace{5pt} Faculty of Engineering Upper-Year Scholarship}{University of Waterloo}{June 2013}
		\begin{itemize}
  	\vspace{-10pt}
  		\resinneritem{Awarded to the top student in each class based on academic performance.}
  	\end{itemize}
  	\resawardentry{\hspace{5pt} Dean's Honour List}{University of Waterloo}{Mar. 2013 \& June 2013}
	\end{itemize}
  \end{resentry}
\end{ressection}
